...
from src.network.hybrid_based.block import *
...
class MedNeXt(nn.Module):
    ...
    def __init__(self, 
        ...
        checkpoint_style=None,            # Either inside block or outside block
...
if __name__ == "__main__":
    ...
    network = MedNeXt().cuda()
    x = torch.zeros((1,1,256,256), requires_grad=False).cuda()
